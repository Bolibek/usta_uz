...
export default function WorkerCard(props) {
	...
	return (
		<div
			...
			<div
				className={` absolute left-3 top-3 bg-white text-black capitalize rounded-md px-3`}>
				{city}
			</div>
			<div className=" absolute right-3 top-3 bg-red-700 text-white rounded-md px-3">
				Worker
			</div>
			...
			<div className="  px-[0.72rem] h-[15rem]">
				<div className=" flex flex-col w-full relative bg-transparent">
					...
					<div className=" flex flex-row items-center">
						...
						<div className="flex flex-row text-white ">
							<img
								className="mt-[-18px] cursor-pointer w-[2em] h-[2em] ml-0.8 absolute right-0 "
								alt=""
							...
							/>
							<img
								className="absolute mt-[-22px] cursor-pointer w-[2.3em] h-[2.3em] right-8"
								alt=""
				...
				<div className=" text-[0.6em] font-semibold">
					...
					{photoLinks && (
						<div className="flex flex-row justify-between mt-1 text-[1.2em] font-normal">
							<span className="bg-blue-500 text-white px-2 py-[0.16em] cursor-pointer rounded-sm">
								{t("more")}...
							</span>
							<Link to={`/posts/${id}`}>
								<span className="bg-blue-500 text-white px-3 py-[0.22em] cursor-pointer rounded-sm">
									{t("details")}{" "}
									<FontAwesomeIcon
...
// 						<img
// 							className=" cursor-pointer w-[2em] h-[2em] ml-0.5"
// 							alt=""
// 							src="https://img.icons8.com/external-others-inmotus-design/100/32AC49/external-Call-phone-operations-and-functions-others-inmotus-design-3.png"
// 						/>
// 						<img
// 							className=" cursor-pointer w-[2.3em] h-[2.3em]"
// 							alt=""
// 							src="data:image/png;base64,"
// 						/>
// 					</div>
...
// 							.map((sample, index) => (
// 								<img
// 									className="w-[5.5rem] h-[3.3rem] rounded-md mt-2"
// 									src={sample}
// 									alt={`sample ${index}`}
// 								/>
// 							))
